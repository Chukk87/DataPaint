...
public class AppCollectionServiceTests
{
    ...
    {
        // Arrange
        var ownerGroup1 = new OwnerGroup(1, "Group A", "group1@example.com", "1234567890");
        var ownerGroup2 = new OwnerGroup(1, "Group B", "group1@example.com", "1234567890");

        // Act
        var toStringResult = ownerGroup1.ToString();
        var isEqual = ownerGroup1.Equals(ownerGroup2);

        // Assert
        Assert.Equal("OwnerGroup [Id=1, Name=Group 1, ContactEmail=group1@example.com, PhoneNumber=1234567890]", toStringResult);
        Assert.True(isEqual);
    }
}